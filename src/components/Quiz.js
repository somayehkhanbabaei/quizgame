...
const questionsByTopic = {  
  ...
  music: [
    {
      question: "Which composer became deaf late in life?",
    ...
    {
      question: "Which musical symbol indicates to play loudly?",
      options: ["p", "f", "mf", "ff"],
      answer: 1,
    },
  ],
  ...
  const handleOptionClick = (idx) => {
    ...
    setTimeout(() => {
      if (current + 1 < questions.length) {
        ...
        onFinish(idx === questions[current].answer ? score + 1 : score);
      }
    }, 1000);
  };
